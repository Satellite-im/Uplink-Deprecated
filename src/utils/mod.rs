...
pub fn wrap_in_markdown(val: &str) -> String {
    ...
    let replacement_two_underscore_second = "<span class=\"delimiter\">__</span><b>$1</b><span class=\"delimiter\">__</span>";
    ...
    let final_string = regex_two_underscores_first.replace_all(&final_string, replacement_two_underscore_first);
    let final_string = regex_one_underscore.replace_all(&final_string, replacement_one_underscore);
    let final_string = regex_two_underscores_second.replace_all(&final_string, replacement_two_underscore_second);
